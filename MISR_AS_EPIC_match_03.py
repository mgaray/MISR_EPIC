...
# Choose the appropriate subgroup
    ...
    type_1km_masked = subgrp.variables['Type_flag_1km'][:]
...
# Choose the appropriate subgroup
    ...
    type_4km_masked = subgrp.variables['Type_flag_4km'][:]
...
# Convert the masked arrays to numpy arrays that can be properly analyzed
    ...
    epic_aod_1km = ma.filled(aod_1km_masked,fill_value=-9999.0)*aod_1km_sf # Apply scale factor
    epic_ssa_1km = ma.filled(ssa_1km_masked,fill_value=-9999.0)*ssa_1km_sf # Apply scale factor
    epic_type_1km = ma.filled(type_1km_masked,fill_value=-9999.0)
    
    epic_aod_4km = ma.filled(aod_4km_masked,fill_value=-9999.0)*aod_4km_sf # Apply scale factor
    epic_ssa_4km = ma.filled(ssa_4km_masked,fill_value=-9999.0)*ssa_4km_sf # Apply scale factor
    epic_type_4km = ma.filled(type_4km_masked,fill_value=-9999.0)
