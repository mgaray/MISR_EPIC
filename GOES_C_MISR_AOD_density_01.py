...
# Set the filename
    ...
    data_name = "MISR_GOES_C_AOD_2019_08_15_v01.nc"
    
# Set the base file name

    out_base = "_"+misr_name+"_2019_08_15_dense_01.png"
...
#    ref_aod = misr_aod[good]
    ...
    plt.subplot(1, 2, 1)
    plt.hexbin(ref_aod,test_aod,gridsize=100,bins='log',extent=[0,3,0,3],cmap=plt.cm.hot_r)
...
#    good = ((goes_dqf == 0) & (misr_aod > 0))
#    ref_aod = misr_aod[good]
    good = ((goes_dqf == 0) & (misr_raw > 0) & (goes_aod > 0))
    ref_aod = misr_raw[good]
    test_aod = goes_aod[good]

    plt.subplot(1, 2, 1)
    plt.hexbin(ref_aod,test_aod,bins='log',gridsize=50,xscale='log',yscale='log',cmap=plt.cm.hot_r)
#    plt.scatter(ref_aod,test_aod,marker='o',color='black',s=10)   
    plt.title(misr_name+" High Quality")
...
#    good = ((goes_dqf <= 1) & (misr_aod > 0))
#    ref_aod = misr_aod[good]
    good = ((goes_dqf <= 1) & (misr_raw > 0) & (goes_aod > 0))
    ref_aod = misr_raw[good]
    test_aod = goes_aod[good]
